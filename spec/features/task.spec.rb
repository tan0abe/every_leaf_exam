...
RSpec.feature "タスク管理機能", type: :feature do
  let(:task_a) { Task.create!(title: 'こんにちは', content: '世界', priority: '最高', status: '着手中', deadline: '100') }
  background do
  ...
  scenario "タスク詳細のテスト" do
    ...
    expect(page).to have_content "こんにちは 世界 最高 着手中 100"
  end
  ...
  scenario "タスクが終了期限順に並んでいるかのテスト" do
    visit tasks_path
    click_on "終了期限でソートする"
